        ...
        <div class="flex justify-center">
          <div>
            <div class="mt-5" v-if="chatList.length !== 0">
              <h4>チャット</h4>
              <div id="commentSection" class="max-w-lg max-h-[32rem] overflow-y-auto border p-3" ref="commentSectionRef">
                <ul>
          ...
          <div class="mt-5 ml-5">
            <!-- ブックマーク一覧 -->
            <h4>ブックマーク一覧</h4>
            <div id="commentSection" class="max-w-xs overflow-y-auto border p-3 max-h-[32rem]" ref="commentSectionRef">
              <ul>
